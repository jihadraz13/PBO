...
public class GUI_aritmatikasederhana extends JFrame implements MouseListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            JOptionPane.showMessageDialog(jFrame, "Masukan angka Gan");
        }
    ...
    public static void main(String[] args) {
        GUI_aritmatikasederhana kalkulator = new GUI_aritmatikasederhana();
    }
