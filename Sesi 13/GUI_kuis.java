...
public class GUI_kuis extends JFrame implements MouseListener, ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == checkButton) {
            if (randomFirstValue + randomSecondValue == userInputValue) {
                resultText.setText("Selamat, jawaban Agan benar !!");
                getContentPane().setBackground(Color.green);
            } else {
                resultText.setText("Maaf, jawaban Agan salah !!");
    ...
    public static void main(String[] args) {
        GUI_kuis kalkulator = new GUI_kuis();
    }
